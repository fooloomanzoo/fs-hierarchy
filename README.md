...
fs-hierarchy/1.1.0 linux-x64 node-v12.18.0
...
_See code: [src/commands/index.ts](https://github.com/fooloomanzoo/fs-hierarchy/blob/1.1.0/src/commands/index.ts)_
