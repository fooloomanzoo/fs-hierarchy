...
fs-hierarchy/0.0.7 linux-x64 node-v12.18.0
...
_See code: [src/commands/index.ts](https://github.com/fooloomanzoo/fs-hierarchy/blob/0.0.7/src/commands/index.ts)_
<!-- commandsstop -->
